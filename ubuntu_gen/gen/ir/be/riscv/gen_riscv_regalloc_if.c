 ...
 *          created by: /home/heaven7/heaven7/temp/cparser/libfirm/ir/be/scripts/generate_regalloc_if.pl /home/heaven7/heaven7/temp/cparser/libfirm/ir/be/riscv/riscv_spec.pl /home/heaven7/heaven7/temp/build-cparser-Desktop_Qt_5_14_2_GCC_64bit-Debug/libfirm/gen/ir/be/riscv
...
static const unsigned riscv_limited_gp_fp[] = { (1U << REG_GP_FP) };
const arch_register_req_t riscv_single_reg_req_gp_fp = {
	.cls     = &riscv_reg_classes[CLASS_riscv_gp],
	.limited = riscv_limited_gp_fp,
	.width   = 1,
};
...
const arch_register_t riscv_registers[] = {
	...
	},
	{
		.name         = "fp",
		.cls          = &riscv_reg_classes[CLASS_riscv_gp],
		.single_req   = &riscv_single_reg_req_gp_fp,
		.index        = REG_GP_FP,
		.global_index = REG_FP,
		.dwarf_number = 0,
		.encoding     = 8,
...
{
	riscv_reg_classes[CLASS_riscv_gp].mode = mode_Iu;
